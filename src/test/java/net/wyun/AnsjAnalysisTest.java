...
import net.wyun.exo.CarAnalyzer;
...
public class AnsjAnalysisTest {
	...
	{
		System.out.println("=======================\n     Set up test    \n=============================");
		//MyStaticValue.ambiguityLibrary="/data/ws-j/ansj-demo/src/test/resources/library/ambiguity.dic";
		//MyStaticValue. = "/data/ws-j/ansj-demo/src/test/resources/library/crf.model";
		String stopLibPath = ResourceBundle.getBundle("library").getString("stopLibrary");
		System.out.println("stop lib path: " + stopLibPath);
	}
    ...
    System.out.println("generate token stream used time: " + (now - before) / 1000.0 + " s");
    System.out.println("total tokens: " + cnt);
}
...
public void indexTest() throws CorruptIndexException, LockObtainFailedException, IOException, ParseException {
    ...
    String stopLibPath = ResourceBundle.getBundle("library").getString("stopLibrary");
 //   stopLibPath = "/data/ws-j/ansj-demo/library/stopword.txt";
    BufferedReader reader2 = IOUtil.getReader(stopLibPath, "UTF-8");
    String word = null;
